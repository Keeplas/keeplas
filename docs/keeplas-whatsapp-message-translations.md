# Keeplas WhatsApp Message Translations

## `keeplas_tc_reconfirm_en`

### EN

Hi! You're receiving this because {{1}} listed you as a trusted contact. We can't confirm that they're still active. Please log in to Keeplas and go to the "Share with me" page to confirm their status and keep their continuity protection up to date, or unlock their vault if needed.
...
We haven't seen any activity from you on Keeplas in a while. Please open Keeplas or reply "I'm well" to confirm you're okay. This will reset your activity check and prevent an escalation that could give your trusted contacts access to your vault.
...
Hi! {{1}} chose you as a trusted contact on Keeplas. If you accept, you'll securely hold one encrypted shard of their recovery key. You won't be able to see their data unless they can no longer confirm their activity and Keeplas triggers their recovery process. Tap below to accept. This link is valid for 72 hours.
...
Hi! {{1}} added you as a recipient for their Keeplas Vault. No action is needed right now. Keeplas will only contact you if a specific event configured by {{1}} is triggered. Thanks for being there.

...
const STEPS: TimelineStep[] = [
  ...
  },
  {
    ...
    titleClass: "text-on-primary font-black text-lg",
    description:
                ...
                <div key={step.title} className="relative pl-12">
                  ...
                  {isFinal ? (
                    <div className="bg-on-primary/5 p-4 rounded-xl backdrop-blur-sm">
                      <p className={`font-black text-lg mb-1.5 ${step.titleClass}`}>
                        {step.title}
                      </p>
                    ...
                    <>
                      <p className={`font-bold text-base mb-1 ${step.titleClass}`}>
                        {step.title}
                      </p>

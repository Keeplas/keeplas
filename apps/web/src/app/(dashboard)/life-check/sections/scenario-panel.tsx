...
> = {
  ...
  alert_authority: {
    ...
    description:
      "Notify your nominated legal authority once unavailability is confirmed.",
...
export function ScenarioPanel() {
  ...
  if (data === undefined) {
    return <Loader label="Loading Scenario Engine" />;
  }
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <section className="col-span-12 lg:col-span-8 space-y-8">
          <div className="bg-surface-container-lowest p-8 md:p-10 rounded-3xl shadow-2xl shadow-primary/5 relative overflow-hidden">
                  ...
                  return (
                    <div key={step._id} className="relative">
                      ...
                      <div className="flex justify-between items-start gap-4">
                        <div className="flex-1">
                          ...
                          <div className="mt-4 flex flex-wrap gap-3">
                            {step.actions.map((action, i) => {
                              const meta =
                                ACTION_META[action.actionType as ActionType];
                              const isHighlight =
                                action.actionType === "grant_access";
                              return (
                                <div
                                  key={i}
                                  className={cn(
                        ...
                        <button
                          onClick={() => setDialog({ mode: "edit", step })}
        ...
        <aside className="col-span-12 lg:col-span-4 space-y-8">
          {/* Engine Status */}
          <div className="bg-primary text-white p-8 rounded-3xl shadow-2xl shadow-primary/10 relative overflow-hidden">
            ...
            <p className="text-body-md text-on-primary-container">
              ...
              {lastCheck ? formatTimeAgo(lastCheck) : "—"}. All scenarios
              synchronized with the main vault.
            </p>
          </div>
      ...
      <DialogContent className="max-h-[92vh] p-0 flex flex-col overflow-hidden">
        <DialogHeader className="shrink-0 static">
          <div>
            ...
            <DialogDescription>
              Pick when in the inactivity window this milestone fires and which
              actions execute.
            </DialogDescription>
          </div>
        ...
        <form
          ...
          className="px-6 pb-6 pt-4 space-y-5 flex-1 overflow-y-auto min-h-0"
        >
          ...
          <div className="space-y-2">
            ...
            <InfoCallout icon={ICON_PATHS.encrypted} tone="info">
              ...
              messages keep their own per-item triggers and are not duplicated
              here.
            </InfoCallout>
                  ...
                  <div className="rounded-lg bg-surface p-3 border border-outline-variant/30 space-y-2">
                    ...
                    <p className="text-sm text-on-surface-variant">
                      ...
                      {vaultRecipientNames.length > 0 ? (
                        <>
                          The following trusted contacts now hold access to the
                          vault:{" "}

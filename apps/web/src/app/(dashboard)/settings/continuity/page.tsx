    ...
    <div className="space-y-6">
      <header>
        ...
        <p className="text-body-md text-on-surface-variant max-w-2xl">
          ...
          Disabling here suspends Life Check escalation and the Scenario
          Engine in lock-step — perfect for off-grid trips. Use Travel Mode
          when you have a return date so everything resumes automatically.
        </p>
      </header>

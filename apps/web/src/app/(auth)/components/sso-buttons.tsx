...
export function SSOButtons({ redirectTo, disabled, onError, setLoading }: SSOButtonsProps) {
  ...
  async function handleOAuth(provider: "google" | "apple") {
    ...
    try {
      ...
      onError(`Failed to sign in with ${provider === "google" ? "Google" : "Apple"}. Please try again.`);
      setLoading(false);
    }
  }

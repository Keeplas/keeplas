...
export function LoginForm() {
  ...
  return (
    <main className="min-h-screen flex flex-col md:flex-row">
      {/* Left Side: Brand/Hero — Consistent with Signup */}
            ...
            <div className="grid grid-cols-1 gap-5">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-end ml-1">
                  <label
                    className="font-label text-xs uppercase tracking-[0.1em] font-bold text-on-surface-variant"
                    htmlFor="password"
                  >
                    Password
                  </label>
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    required
                    className="w-full bg-surface-container-low border border-transparent rounded-xl px-4 py-3 pr-11 text-on-surface placeholder:text-outline-variant focus:border-secondary/15 focus:bg-surface-container-high transition-all focus:outline-none"
                  />
                  <button
                    type="button"

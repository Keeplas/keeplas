/**
 * ISO-3166-1 alpha-2 country list used by the legal-info onboarding step.
 * Country code drives the applicable inheritance jurisdiction recorded
 * with the user — keep stable and lowercased only when persisted.
 */

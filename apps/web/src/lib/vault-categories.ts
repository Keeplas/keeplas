...
export interface CategoryConfig {
  key: VaultCategory;
  label: string;
  icon: string; // SVG path for heroicons outline
  emptyMessage: string;
}
...
export const CATEGORIES: CategoryConfig[] = [
  ...
  },
  {
    ...
    emptyMessage:
      "No letters yet. Compose one to leave a message for your loved ones.",
  },
  {
    key: "credential",
    label: "Credentials",
  ...
  },
  {
    ...
    emptyMessage: "No property records yet. Add your first.",
  },
  {
    key: "insurance_policy",
    label: "Insurance Policies",
    icon: "M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z",
    emptyMessage: "No insurance policies yet. Add your first.",
  },
  {
    key: "subscription",
    ...
    emptyMessage: "No subscriptions yet. Add your first.",
  },
  {
    key: "contacts",
    label: "Contacts",
    icon: "M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z",
    emptyMessage: "No contacts yet. Add your first.",
  },
  {
    key: "wishes",
    label: "Wishes",
    ...
    emptyMessage: "No wishes yet. Share what matters to you.",
  },
  {
    key: "other",
    label: "Other",
  ...
  // "Other" is a catch-all and always sorts last; everything else is
  // alphabetical by label so the picker stays easy to scan.
].sort((a, b) =>
  a.key === "other"
    ? 1
    : b.key === "other"
...
export function getCategoryConfig(key: VaultCategory): CategoryConfig {
